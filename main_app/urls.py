...
urlpatterns = [
    ...
    path("send_student_notification_all/", hod_views.send_student_notification_all,
         name='send_student_notification_all'),
    path("send_staff_notification/", hod_views.send_staff_notification,
         name='send_staff_notification'),
    path("send_staff_notification_all/", hod_views.send_staff_notification_all,
         name='send_staff_notification_all'),
    ...
    path("staff/attendance/update_attendance/",
    ...
    path("staff/assignment/save/", staff_views.staff_save_assignment, name='staff_save_assignment'),
    path("staff/assignment/view/", staff_views.staff_view_assignments, name='staff_view_assignments'),
    path("staff/assignment/review/<int:assignment_id>/", staff_views.staff_review_submissions, name='staff_review_submissions'),
    path("staff/assignment/submission/update/", staff_views.staff_update_submission_status, name='staff_update_submission_status'),
    ...
    path('student/assignment/view/', student_views.student_view_assignments, name='student_view_assignments'),
    path('student/assignment/submit/', student_views.student_submit_assignment, name='student_submit_assignment'),
